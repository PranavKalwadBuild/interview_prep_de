{%- macro incremental_merge_unicorn(source_table, target_schema, reference_seed, unique_key_columns) -%}
    -- UNICORN (EU SAP) — mirrors EAGLE structure but different source schemas
    -- Combined with EAGLE via UNION ALL in global models; explicit column aliases required
    ...
    LEFT JOIN {{ this }} tgt
        ...
        {%- endfor %})
        AND tgt._source_system = 'UNICORN'
