-- ============================================================
-- 00-setup / 03-seed-source-data.sql
-- Database: dm_oltp
--
-- Seeds the OLTP source tables created in 01-source-oltp-schema.sql.
-- Identical data to sql-implementation/00-setup/02-seed-data.sql.
-- Run order: 01-source-oltp-schema.sql → this file → pattern files.
--
-- Intentional flaws preserved (same as sql-implementation):
--   emp 10, 15 — NULL salary (contractors)
--   emp 19     — salary = 0.00 (soft duplicate of emp 18)
--   emp 22     — NULL email
--   emp 35     — Terminated, termination_date set
--   emp 41     — future hire_date (2025-08-01)
...
--   leave_request 11 — NULL leave_type
--   leave_requests emp 12 — overlapping date ranges
-- ============================================================
